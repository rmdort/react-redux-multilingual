...
var _reactReduxMultilingual = require('react-redux-multilingual');
...
var IntlProvider = function (_React$Component) {
  ...
  function IntlProvider(props) {
    ...
    _this.translate = function (key, placeholders, isHTML) {
      var result = (0, _utils.translateKey)(key, _this.props.translations[_this.props._locale || _this.props.locale]['messages']);
    ...
    if (!props._locale) {
      props.setLocale(_this.props.locale || 'en');
    }
    return _this;
  }
...
function mapDispatchToProps(dispatch) {
  return {
    setLocale: function setLocale(val) {
      return dispatch(_reactReduxMultilingual.IntlActions.setLocale(val));
    }
  };
}

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(IntlProvider);